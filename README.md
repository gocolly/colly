...
[![GoDoc](https://godoc.org/github.com/hktalent/colly?status.svg)](https://pkg.go.dev/github.com/hktalent/colly/)
[![Backers on Open Collective](https://opencollective.com/colly/backers/badge.svg)](#backers) [![Sponsors on Open Collective](https://opencollective.com/colly/sponsors/badge.svg)](#sponsors) [![build status](https://github.com/hktalent/colly/actions/workflows/ci.yml/badge.svg)](https://github.com/hktalent/colly/actions/workflows/ci.yml)
...
[![view examples](https://img.shields.io/badge/learn%20by-examples-0077b3.svg?style=flat-square)](https://github.com/hktalent/colly/tree/master/_examples)
...
See [examples folder](https://github.com/hktalent/colly/tree/master/_examples) for more detailed examples.
...
require (
        github.com/hktalent/colly/ latest
)
```

## Bugs

Bugs or suggestions? Visit the [issue tracker](https://github.com/hktalent/colly/issues) or join `#colly` on freenode
...
<a href="https://github.com/hktalent/colly/graphs/contributors"><img src="https://opencollective.com/colly/contributors.svg?width=890" /></a>
